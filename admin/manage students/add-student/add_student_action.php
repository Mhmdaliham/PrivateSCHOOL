...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT Email, Username FROM students WHERE Email = ? OR Username = ?";
    ...
    if ($stmt->num_rows > 0) {
        ...
        $insertStmt = $mysqli->prepare("INSERT INTO students (FirstName, LastName, Email, Phone, Address, Username, Password) VALUES (?, ?, ?, ?, ?, ?, ?)");
